...
DYNAMIC_TEMPLATES: Dict[str, List[Dict[str, Any]]] = {
    ...
    "Advanced": [
        ...
        {"stem": "So intense _______ the heat that the tarmac on the road began to melt.", "category": "Grammar", "difficulty": 3, "options": [{"text": "was", "correct": True}, {"text": "is", "correct": False}, {"text": "had been", "correct": False}, {"text": "would be", "explanation": "Inversion after 'So + adjective' is used for emphasis."}], "explanation": "Inversion after 'So + adjective' is used for emphasis."},
